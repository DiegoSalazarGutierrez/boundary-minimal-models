...
\begin{abstract}
  ...
  Andrews-Gordon's generalization of the Rogers-Ramanujan identities is used in the proof, and our results in turn provide a natural interpretation of these identities. \\
  \smallskip
...
It turns out this problem is deeply connected with the Rogers-Ramanujan $q$-series identities and Andrews-Gordon's generalization \cite{gordon_combinatorial_1961} and \cite{andrews_analytic_1974}, namely
\begin{equation}
  \label{eq:1}
...
\begin{proposition}[{\cite{arakawa_associated_2015}, \cite[Proposition 2.3.1]{arakawa_remark_2012} and \Cref{sec:graded-jet-algebras}}]
  \label{prp:7}
