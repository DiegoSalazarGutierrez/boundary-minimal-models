...
%An infinite sequence  uniquely corresponds to a partition $[\underbrace{1, \dots, 1}_{f_1}, \underbrace{2, \dots, 2}_{f_2}, \dots]$. Therefore, we have two ways of writing a partition.
...
\begin{theorem}
  ...
  \begin{equation*}
    \ch_{L(c_{2, 2s + 1}, h_{1, i})}(t, q) = %q^{h_{1, i}}\left(
