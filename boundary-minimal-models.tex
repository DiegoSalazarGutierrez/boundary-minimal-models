...
\begin{proof}[Proof of \Cref{thr:3}]
  ...
  \end{equation*}
  From \eqref{eq:10}, \eqref{eq:11} and \eqref{eq:14}, we conclude that
  \begin{equation}
    \label{eq:12}
  ...
  This would imply that $\phi_{\Vir_{p, q}}$ is also an isomorphism, a contradiction to \Cref{exa:19}.
