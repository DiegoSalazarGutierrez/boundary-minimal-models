...
As in the proof of \Cref{lmm:11}, let $w \in J(c_{2, 2s + 1}, h_{1, i})$ be such that $\lp(w) = L_{-1}^i|c_{2, 2s + 1}, h_{1, i}\rangle$, and we set:
\begin{align*}
...
\begin{proof}
  ...
  We note that for a partition $\lambda \notin P^{s, i}$ with $2 \ge \lambda_1$, there is $u \in (L_{-2}^s, u_1, \dots, u_i)_{\psn}$ such that $\lp(u) = u_{\lambda}$.
